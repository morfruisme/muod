...
public class MudEffects {
    ...
    public static void updateAndRender(DrawContext drawContext) {
        ...
        EFFECTS.forEach(effect -> effect.render(drawContext, x, y));
    }
    ...
    public static class MudEffect {
        ...
        public void render(DrawContext ctx, int x, int y) {
            ...
            ctx.drawTexture(TEXTURE, x, y, SIZE, SIZE, u, v, SPRITE_SIZE, SPRITE_SIZE, 3*SPRITE_SIZE, 3*SPRITE_SIZE);
        }
    }
}
